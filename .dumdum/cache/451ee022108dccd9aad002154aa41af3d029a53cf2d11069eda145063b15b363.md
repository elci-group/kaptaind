## `tests/fixtures/adapters/python/modified/async_to_class_after.py`
...
**Key symbols:** class reset

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 0 detected function-like definitions, hash 538792628086289068.
