## `tests/fixtures/adapters/python/positive/decorated.py`
...
**Key symbols:** function log, function greet

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 7 lines, 2 detected function-like definitions, hash 351376275427096564.
