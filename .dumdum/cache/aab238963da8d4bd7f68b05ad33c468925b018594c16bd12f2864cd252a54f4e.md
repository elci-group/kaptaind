...
**How it works:** The current snapshot has 111 lines and 8 function-like definitions. Read the public functions first, then follow data flow into helpers before changing behavior.

**Key symbols:** struct QualificationConfig, function default_stability_threshold, function default_min_pass_streak, function default_max_allowed_diff, function default_cooldown, impl QualificationConfig, function default, module duration_string, function serialize, function deserialize, function parse_duration

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 111 lines, 8 detected function-like definitions, hash 17743852289833812598.
