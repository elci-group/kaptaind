## `tests/fixtures/adapters/python/breaking/rename_class_before.py`
...
**Key symbols:** class OldName

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 0 detected function-like definitions, hash 8049863537967713646.
