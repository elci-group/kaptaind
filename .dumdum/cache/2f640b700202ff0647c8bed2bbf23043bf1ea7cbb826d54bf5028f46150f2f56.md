## `tests/fixtures/adapters/python/breaking/remove_function_after.py`
...
**Key symbols:** function stable_api

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 1 detected function-like definitions, hash 9913707772514926367.
