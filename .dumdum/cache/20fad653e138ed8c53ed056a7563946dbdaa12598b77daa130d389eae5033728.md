## `tests/fixtures/adapters/python/edge/nested_methods.py`
...
**Key symbols:** class Handler, function handle, function validate

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 6 lines, 2 detected function-like definitions, hash 880211091704538102.
