## `tests/fixtures/adapters/javascript/positive/classes.js`
...
**Key symbols:** class UserService, method constructor, method find

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 10 lines, 0 detected function-like definitions, hash 5397787337972132059.
