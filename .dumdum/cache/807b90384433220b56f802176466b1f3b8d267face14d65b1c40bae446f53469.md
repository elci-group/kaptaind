## `tests/fixtures/adapters/python/positive/async_functions.py`
...
**Key symbols:** function fetch, function send

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 6 lines, 0 detected function-like definitions, hash 16450734694147325312.
