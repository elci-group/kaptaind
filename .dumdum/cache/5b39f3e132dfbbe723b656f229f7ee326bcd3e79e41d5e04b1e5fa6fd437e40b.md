## `tests/fixtures/adapters/go/positive/multiple_exported.go`
...
**What it is:** This is a Go file in `kaptaind`. It verifies behavior so changes can be made with more confidence.
...
**Key symbols:** type Config, function NewConfig

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 12 lines, 0 detected function-like definitions, hash 16470002017360274215.
