## `tests/fixtures/adapters/python/modified/function_to_async_before.py`
...
**Key symbols:** function fetch

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 1 detected function-like definitions, hash 12624658233335548507.
