## `tests/fixtures/adapters/rust/modified/fn_async_before.rs`
...
**Key symbols:** function compute

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 3 lines, 1 detected function-like definitions, hash 1785696295584289059.
