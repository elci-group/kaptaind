## `tests/fixtures/adapters/javascript/modified/function_to_class_before.js`
...
**Key symbols:** function Widget

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 0 detected function-like definitions, hash 11235287960206043230.
