## `tests/fixtures/adapters/python/breaking/remove_function_before.py`
...
**Key symbols:** function stable_api, function deprecated_api

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 6 lines, 2 detected function-like definitions, hash 18432371474908867332.
