## `tests/fixtures/adapters/python/modified/control_before.py`
...
**Key symbols:** function helper

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 1 detected function-like definitions, hash 14119950344879753770.
