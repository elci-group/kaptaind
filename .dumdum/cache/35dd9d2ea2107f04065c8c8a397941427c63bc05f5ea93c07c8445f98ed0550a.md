...
**How it works:** The current snapshot has 62 lines and 1 function-like definitions. Read the public functions first, then follow data flow into helpers before changing behavior.

**Key symbols:** struct StabilityRecord, struct TestOutcomeRecord, struct StabilityEntry, function default_confidence

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 62 lines, 1 detected function-like definitions, hash 2834978383113845188.
