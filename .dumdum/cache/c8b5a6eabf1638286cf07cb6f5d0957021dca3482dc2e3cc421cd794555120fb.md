## `tests/fixtures/adapters/python/breaking/rename_class_after.py`
...
**Key symbols:** class NewName

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 2 lines, 0 detected function-like definitions, hash 14306090641700265943.
