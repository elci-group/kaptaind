## `tests/fixtures/adapters/javascript/positive/functions.js`
...
**Key symbols:** function greet, function loadUser

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 8 lines, 0 detected function-like definitions, hash 16585858989901823143.
