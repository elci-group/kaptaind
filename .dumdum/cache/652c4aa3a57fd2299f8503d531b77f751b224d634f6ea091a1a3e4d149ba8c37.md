## `tests/fixtures/adapters/go/breaking/remove_function_before.go`
...
**Key symbols:** function Add

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 6 lines, 0 detected function-like definitions, hash 12068608791179650192.
