## `tests/fixtures/adapters/javascript/edge/multiline_export.js`
...
**Key symbols:** function splitAcrossLines

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 7 lines, 1 detected function-like definitions, hash 3621625239492350464.
