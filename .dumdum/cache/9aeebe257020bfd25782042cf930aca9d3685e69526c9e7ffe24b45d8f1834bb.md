## `tests/fixtures/adapters/rust/modified/control_after.rs`
...
**Key symbols:** function answer

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 3 lines, 1 detected function-like definitions, hash 17209094346153468170.
