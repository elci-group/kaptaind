## `tests/fixtures/adapters/java/modified/interface_to_enum_after.java`
...
**What it is:** This is a Java file in `kaptaind`. It verifies behavior so changes can be made with more confidence.
...
**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 11 lines, 0 detected function-like definitions, hash 13255641563522372923.
