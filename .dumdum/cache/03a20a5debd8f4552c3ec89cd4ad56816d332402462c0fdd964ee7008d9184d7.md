## `tests/fixtures/adapters/go/edge/method_receiver.go`
...
**Key symbols:** type Server, method Start

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 11 lines, 0 detected function-like definitions, hash 7954041404100148701.
