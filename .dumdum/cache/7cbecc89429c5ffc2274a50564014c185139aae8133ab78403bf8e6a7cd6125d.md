## `tests/fixtures/adapters/python/edge/private_and_dunder.py`
...
**What it is:** This is a Python file in `kaptaind`. It verifies behavior so changes can be made with more confidence.
...
**Key symbols:** class _Internal, function __init__, function _helper, function __mangled

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 11 lines, 3 detected function-like definitions, hash 9727465190282265888.
