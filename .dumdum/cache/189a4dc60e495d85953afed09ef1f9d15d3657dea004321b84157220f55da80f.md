## `tests/fixtures/adapters/javascript/breaking/remove_function_after.js`
...
**Key symbols:** function greet

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 4 lines, 0 detected function-like definitions, hash 13367826273350608692.
