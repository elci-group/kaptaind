## `packaging/winget/elci-group.kaptaind.yaml`
...
**What it is:** This is a YAML file in `kaptaind`. It configures tooling or runtime behavior rather than directly serving end-user screens.
...
**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 30 lines, 0 detected function-like definitions, hash 11898669617476179539.
