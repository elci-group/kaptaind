## `.amber/.amber/rustsec-advisory-db/support.toml`
...
**What it is:** This is a TOML file in `kaptaind`. It configures tooling or runtime behavior rather than directly serving end-user screens.
...
**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 3 lines, 0 detected function-like definitions, hash 12710294933231170832.
