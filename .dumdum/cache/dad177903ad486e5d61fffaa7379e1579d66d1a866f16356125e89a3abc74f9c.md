## `tests/fixtures/adapters/javascript/negative/strings.js`
...
**Key symbols:** function logger

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 9 lines, 1 detected function-like definitions, hash 13213868020333539618.
