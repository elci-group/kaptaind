...
**How it works:** The current snapshot has 114 lines and 1 function-like definitions. Read the public functions first, then follow data flow into helpers before changing behavior.

**Key symbols:** function handle_analyze

**Media and demos:** No inline GIF, image, or VHS recording references were detected in this snapshot.

**Maintainer notes:** Keep the generated explanation aligned when this file changes. Current snapshot: 114 lines, 1 detected function-like definitions, hash 11903711131923953045.
