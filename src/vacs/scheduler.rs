...
impl Scheduler {
    ...
    fn generate_flow_diagram(&self, scored: &ScoredConcept) -> String {
        ...
        for (i, file) in files.iter().enumerate() {
            ...
            nodes += "\" text-anchor=\"middle\" fill=\"white\" font-size=\"12\" font-family=\"sans-";
            nodes += "serif\"/>";
            nodes += &short_name;
            nodes += "</text>\n";
    ...
    fn generate_architecture_diagram(&self, scored: &ScoredConcept) -> String {
        ...
        for (i, file) in files.iter().enumerate().take(6) {
            ...
            components += "\" text-anchor=\"middle\" fill=\"white\" font-size=\"10\" font-family=\"sans-";
            components += "serif\">";
    ...
    fn generate_api_diagram(&self, scored: &ScoredConcept) -> String {
        let files = &scored.concept.source_refs.files;
        let endpoints: Vec<_> = files.iter()
    ...
    fn generate_dependency_diagram(&self, scored: &ScoredConcept) -> String {
        ...
        for (i, pkg) in unique_packages.iter().enumerate().take(5) {
            let angle = (i as f64 / unique_packages.len().min(5) as f64) * 2.0 * std::f64::consts::PI;
            ...
            nodes += "\" text-anchor=\"middle\" fill=\"white\" font-size=\"10\" font-family=\"sans-";
            nodes += "serif\">";
            nodes += &pkg_escaped;
            nodes += "</text>\n";
    ...
    fn generate_generic_diagram(&self, scored: &ScoredConcept) -> String {
        ...
        svg += "</text>\n";
        svg += "<text x=\"250\" y=\"115\" text-anchor=\"middle\" font-size=\"12\" font-family=\"sans-";
        svg += "serif\" fill=\"";
        svg += "#666";
        svg += "\">";
    ...
    async fn generate_video_placeholder(&self, scored: &ScoredConcept) -> anyhow::Result<String> {
        ...
        svg += "<text x=\"320\" y=\"280\" text-anchor=\"middle\" font-size=\"20\" font-family=\"sans-";
        svg += "serif\" fill=\"white\">";
        svg += &capitalize(concept_type);
        svg += " Animation</text>\n";
        svg += "<text x=\"320\" y=\"310\" text-anchor=\"middle\" font-size=\"12\" font-family=\"sans-";
